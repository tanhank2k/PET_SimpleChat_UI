...
public class slag_program {
	public static void main(String[] arg) {
		...
		while (condition) {
			...
			System.out.println(
					"9. Funny Question: Show a random Slang-word, choose right the definition match Slang-word.");
			System.out.println(
					"10. Funny Question: Show a random Definition, choose right the slang-word match Slang-word.");
			...
			switch (choice) {
				...
				case "9":
					System.out.println(
							"------------------Funny Question: Show a random Slang-word ------------------------------");
					while (condition_feature) {
				...
				case "10":
					System.out.println(
							"------------------Funny Question: Show a random Definition-------------------------------");
					while (condition_feature) {
